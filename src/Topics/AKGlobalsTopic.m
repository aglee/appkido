...
{
    return [_database numberOfGlobalsGroupsForFrameworkNamed:_topicFramework];
}
...
- (AKSubtopic *)subtopicAtIndex:(int)subtopicIndex
{
    ...
    NSArray *groupNodes =
        [AKSortUtils
            arrayBySortingArray:
                [_database globalsGroupsForFrameworkNamed:_topicFramework]];
